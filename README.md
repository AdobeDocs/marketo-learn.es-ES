...
Si es redactor técnico, administrador de programa o desarrollador del equipo de producto para una solución de [!UICONTROL Adobe Experience Cloud] y debe contribuir a artículos técnicos o crearlos, debe usar el repositorio privado de `https://git.corp.adobe.com/AdobeDocs`.
