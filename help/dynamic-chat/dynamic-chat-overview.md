...
* Chat automatizado
   ...
   * **[Incrustar PDF en conversaciones](document-cloud-integration.md)**
     *Comparte documentos de PDF en conversaciones personalizadas que diseñas en [!UICONTROL Dynamic Chat].*
   ...
   * **[Capturando atributos deducidos](capture-inferred-attributes.md)**
     *Podemos identificar y rellenar atributos deducidos de cada posible cliente capturado a través de Dynamic Chat mediante el uso del Munchkin ID.*
   ...
   * **[Conversaciones en SDK](conversations-sdk.md)**
     *Aprenda a implementar Conversations SDK para convertir cualquier clic de CTA en una conversación atractiva.*
   ...
   * **[Páginas de aterrizaje de conversación](conversational-landing-pages.md)**
     *Con solo unos clics, instale los flujos de conversación de Dynamic Chat en cualquier página de aterrizaje (páginas de aterrizaje de Marketo o personalizada) y convierta cualquier vínculo o botón para almacenar en déclencheur una conversación.*
