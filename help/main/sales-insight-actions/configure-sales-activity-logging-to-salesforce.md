...
Aprenda a configurar y registrar las actividades de Acciones de Insight de ventas en su cuenta de [!DNL Salesforce].
...
* [Acceder a tu  [!DNL Sales Insight Actions] instancia](/help/main/sales-insight-actions/accessing-your-sales-insight-actions-instance.md){target="_blank"}
